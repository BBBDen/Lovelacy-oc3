...
class ControllerExtensionModuleRemarketing extends Controller {
	private $error = [];
	private $purchased_domain = 'https://lovelace.by/';
	private $order = '1164477';
	private $seller = 'opencartforum'; 
	private $version = '5.5';
	...
	public function index() {
		...
		$data['text_ecommerce_gtag'] = $this->language->get('text_ecommerce_gtag');
		...
		if (isset($this->request->post['remarketing_ecommerce_gtag_status'])) {
			$data['remarketing_ecommerce_gtag_status'] = $this->request->post['remarketing_ecommerce_gtag_status'];
		} else {
		...
		if (isset($this->request->post['remarketing_ecommerce_measurement_user_id'])) {
			$data['remarketing_ecommerce_measurement_user_id'] = $this->request->post['remarketing_ecommerce_measurement_user_id'];
		} else {
			$data['remarketing_ecommerce_measurement_user_id'] = $this->config->get('remarketing_ecommerce_measurement_user_id');
		}
...
{products}";
	...
	protected function checkInstall() {
		...
		if (version_compare(VERSION,'3.0.0.0', '>=')) {
			...
			'catalog/view/theme/{*}/template/checkout/simplecheckout_cart.twig'
			];
		} else {
			$files = [
			'admin/controller/sale/order.php',
