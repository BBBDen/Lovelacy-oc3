<?php
// Heading
$_['heading_title']    			= '<span style="color:red; font-weight:bold;"><i class="fa fa-rocket"></i> SP</span> Товарный фид для Google Merchant и Facebook - v1.0';
...
$_['entry_google_merchant_xml_original_image_status']   = 'Выгружать оригиналы картинок (быстрее)';
$_['entry_google_merchant_xml_key']   = 'Ключ защиты ссылок (рекомендуется)';
$_['entry_google_merchant_xml_additional_images']   = 'Дополнительные картинки (медленнее)';
$_['entry_google_merchant_xml_multiplier']   = 'Коэффициент наценки (1 - 100%, 0.7 - -30%, 1.2 - +20%)';
$_['entry_google_merchant_xml_utm']   = 'UTM-метки. Переменные: {product_id}, {product_model}';
$_['entry_google_merchant_xml_original_description']   = 'HTML-описание';
$_['entry_google_merchant_xml_currency']   = 'Основная валюта фида';
$_['entry_google_merchant_xml_custom_sql']   = 'Дополнительное условие SQL для выгрузки (пример AND p.export = 1 AND p.stock_status_id = 3). Использовать если знаете что делаете.';
$_['entry_google_merchant_xml_special']   = 'Выгружать акционные цены';
$_['entry_google_merchant_xml_min_price']   = 'Минимальная цена для выгрузки';
$_['entry_google_merchant_xml_max_price']   = 'Максимальная цена для выгрузки';
$_['entry_google_merchant_xml_gtin']   = 'Откуда брать GTIN (если используется). Пример: sku, upc, mpn и тп.';
$_['entry_google_merchant_xml_mpn']   = 'Откуда брать MPN (если используется). Пример: sku, upc, mpn и тп.';
$_['entry_google_merchant_xml_zero_quantity']   = 'Выгружать товары с количеством только больше 0';
$_['entry_google_merchant_xml_condition']   = 'Condition (new - новый,refurbished - восстановленный, used - б/у)';
$_['entry_google_merchant_xml_links']   = 'Ссылки на выгрузку';
$_['text_credits']        = '
