...
$_['text_empty']       							= '<h2 class="title title_left"><span>У кошику немає товарів.</span> Перейдіть в каталог і додайте в корзину будь-який товар, який вам сподобається</h2><a class="btn" href="%s">Перейти в каталог </a>';
$_['text_day']         							= 'День';
$_['text_week']        							= 'Неделя';
...
$_['text_vack']              					= '← Вернуться к покупкам';
$_['text_color']              					= 'Цвет';
$_['certificate_text']          = 'Подарочный сертификат';
$_['promo_error']          = 'Введіть промокод';
$_['text_loading']          = 'Застосовую...';
