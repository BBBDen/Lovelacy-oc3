            ...
            if ($response && $response['rows']) {
                ...
                foreach ($response['rows'] as $assortiment) {
                   ...
                   if (isset($this->options['loadPurchasePrice']) && $this->options['loadPurchasePrice'] === true) {
                    ...
                    if (isset($assortiment['salePrices'][1]['value']) && $assortiment['salePrices'][1]['value'] != 0) {
                        $products[$assortiment['id']]['price'] = (((float)$assortiment['salePrices'][1]['value']) / 100);
                    } elseif (isset($assortiment['product']['salePrices'][0]['value'])) {
                        $products[$assortiment['id']]['price'] = (((float)$assortiment['product']['salePrices'][1]['value']) / 100);
                    } else {
