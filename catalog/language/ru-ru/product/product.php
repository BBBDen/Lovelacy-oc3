...
$_['text_related2']             = 'Похожие товары';
$_['text_tags']                = 'Теги:';
...
$_['error_empty_email']               = 'E-mail обязателен для заполнения';
$_['error_email']          = 'E-Mail адрес введен неверно!';
$_['error_denomination']          = 'Введите сумму';
$_['certificate_text']          = 'Подарочный сертификат';
...
$_['text_in_cart']             = '<a class="button-cart btn" href="#" id="button-cart" data-loading-text="%s">Добавить в корзину</a>';
$_['text_in_cart_exists']      = '<a class="button-cart btn btn-cart-added" href="#" data-loading-text="%s">Перейти в корзину</a>';
$_['certificate_success']          = 'Сертификат успешно добавлен в корзину';
$_['text_size_guide']          = '<a class="product__sizes" href="%s">Руководство по размерам </a>';
$_['text_image']          = 'Дополните образ';
$_['text_size_error']          = 'Выберите размер!';
$_['text_sale_description']          = 'Акция';
