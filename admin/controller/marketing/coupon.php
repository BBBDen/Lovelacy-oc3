...
class ControllerMarketingCoupon extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['sum_order_products'])) {
			$data['sum_order_products'] = $this->request->post['sum_order_products'];
		} elseif (!empty($coupon_info)) {
			$data['sum_order_products'] = $coupon_info['sum_order_products'];
		} else {
			$data['sum_order_products'] = '';
		}
        ...
        if (isset($this->request->post['coupon_product_gift'])) {
            $products = $this->request->post['coupon_product_gift'];
        } elseif (isset($this->request->get['coupon_id'])) {
            $products = $this->model_marketing_coupon->getCouponGiftProducts($this->request->get['coupon_id']);
        } else {
            $products = array();
        }

        $data['coupon_gift_product'] = array();
