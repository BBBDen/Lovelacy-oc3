...
class ControllerExtensionPaymentBegateway extends Controller {
  ...
  public function index() {
    ...
    $data['breadcrumbs'][] = array(
      ...
      'href'      => $this->url->link('extension/payment/begateway', 'user_token=' . $this->session->data['user_token'], 'SSL'),
      'separator' => ' :: '
    );

    $data['action'] = $this->url->link('extension/payment/begateway', 'user_token=' . $this->session->data['user_token'], 'SSL');
