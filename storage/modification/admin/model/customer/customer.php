...
class ModelCustomerCustomer extends Model {
    ...
    public function getData($path_id)
    {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "card_subscribe_info as csi LEFT JOIN " . DB_PREFIX . "customer c ON (csi.customer_id = c.customer_id) WHERE card_subscribe_info_id = '". (int)$path_id ."'");
        return $query->row;
    }
