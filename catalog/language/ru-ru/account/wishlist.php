...
$_['text_empty']    = '<h2 class="title title_left"><span>В избранном нет товаров.</span>Перейдите в каталог и добавьте в избранное любой товар, который вам понравится</h2><a class="btn" href="%s">Перейти в каталог </a>';
