...
$_['entry_related_product_quantity_sum'] = 'Суммировать остатки сопутствующих товаров';
$_['entry_related_product_quantity_sum_desc'] = 'Функция работает если в товарах присутсвуют сопутствующие товары, основному товару будет суммировать остатки сопутствующих';
