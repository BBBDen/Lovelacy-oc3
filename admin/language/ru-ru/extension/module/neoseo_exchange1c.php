...
$_['entry_disable_missing_tag_remove'] = 'Отключать товары по тегу:';
$_['entry_disable_missing_tag_remove_desc'] = 'Отключать товар по специальному, отдельному тегу. Если данный тег имеет значение Удален тогда товар будет отключен.';
