    ...
    public function index()
    {
        ...
        if (isset($this->session->data['payment_address'])) {
            ...
            foreach ($results as $result) {
                ...
                if ($this->config->get('payment_' . $result['code'] . '_status') || $result['code'] === 'begateway') {
            ...
            if (isset($this->session->data['payment_address'])) {
                if (isset($this->session->data['payment_address']['zone_id']) &&
                    ...
                    if (isset($method_data[$this->__get_code_payment__()])) {
                        unset($method_data[$this->__get_code_payment__()]);
                    }
                }
            }
        ...
        if (isset($this->session->data['payment_method']) && !empty($this->session->data['payment_method'])) {
            $data['current_payment_method'] = $this->session->data['payment_method']['code'];
        } else {
            $data['current_payment_method'] = '';
        }
