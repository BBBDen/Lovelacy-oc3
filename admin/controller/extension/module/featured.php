...
class ControllerExtensionModuleFeatured extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['btn_title'])) {
			$data['error_btn_title'] = $this->error['btn_title'];
		} else {
			$data['error_btn_title'] = '';
		}

		if (isset($this->error['btn_link'])) {
			$data['error_btn_link'] = $this->error['btn_link'];
		} else {
			$data['error_btn_link'] = '';
		}

		if (isset($this->error['name_title'])) {
			$data['error_name_title'] = $this->error['name_title'];
		} else {
			$data['error_name_title'] = '';
		}
		...
		if (isset($this->request->post['name_title'])) {
			$data['name_title'] = $this->request->post['name_title'];
		} elseif (!empty($module_info)) {
			$data['name_title'] = $module_info['name_title'];
		} else {
			$data['name_title'] = '';
		}
		...
		if (isset($this->request->post['btn_title'])) {
			$data['btn_title'] = $this->request->post['btn_title'];
		} elseif (!empty($module_info)) {
			$data['btn_title'] = $module_info['btn_title'];
		} else {
			$data['btn_title'] = '';
		}
