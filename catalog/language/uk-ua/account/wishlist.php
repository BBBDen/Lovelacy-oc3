...
$_['text_empty']    = '<h2 class="title title_left"><span>В обраному немає товарів.</span>Перейдіть в каталог і додайте в обране будь-який товар, який вам сподобається</h2><a class="btn" href="%s">Перейти в каталог </a>';;
