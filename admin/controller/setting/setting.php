...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_promo'])) {
			$data['config_promo'] = $this->request->post['config_promo'];
		} else {
			$data['config_promo'] = $this->config->get('config_promo');
		}
		...
		if (isset($this->request->post['config_api_sms_id'])) {
			$data['config_api_sms_id'] = $this->request->post['config_api_sms_id'];
		} else {
			$data['config_api_sms_id'] = $this->config->get('config_api_sms_id');
		}
		...
		if (isset($this->request->post['config_login_way'])) {
			$data['config_login_way'] = $this->request->post['config_login_way'];
		} else {
			$data['config_login_way'] = $this->config->get('config_login_way');
		}
