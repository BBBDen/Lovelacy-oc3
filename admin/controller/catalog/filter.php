...
class ControllerCatalogFilter extends Controller {
	...
	protected function getForm() {
		...
		$results = $this->model_catalog_filter->getFilterCategories($this->request->get['filter_group_id']);
		...
		if (isset($this->request->post['filter'])) {
			...
			$result = $this->model_catalog_filter->getFilterDescriptions($this->request->get['filter_group_id']);
			...
			if ($result) {
                foreach ($result as $item) {
                    ...
                    $data['filters'][] = [
                        ...
                        'image'              => $image,
                        'image_hide'         => $item['image'] ? $item['image'] : 'no_image.png',
